...
class CommonFunctions
{
    ...
    public static function validateDates($strDateOne, $strDateTwo)
    {
        $intResponse = 0;
        // StrDateOne is Business Closing Date and Time
        $strDateOne = strtotime($strDateOne);
        $strDateTwo = strtotime($strDateTwo);
        if ($strDateOne < $strDateTwo) {
            $intResponse = 1;
        }
        return $intResponse;
    }

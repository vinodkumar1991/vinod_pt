...
/* 	public function rules()
	{
		...
		return array(
			array('id, book_id, userid, mechanic_id, amount, created_date, status', 'required'),
			array('id, userid, mechanic_id, amount, status', 'numerical', 'integerOnly'=>true),
			array('book_id', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, book_id, userid, mechanic_id, amount, created_date, status', 'safe', 'on'=>'search'),
		);
	} */

...
class MechanicShopDetails extends CActiveRecord {
    ...
    public static function create($arrMechanic) {
        ...
        $objMechanicShop->lati_longitude = $arrMechanic['lati_longitude'];
    ...
    public static function updateShopLocation($intShop, $arrShop) {
        $objCommand = Yii::app()->db->createCommand();
        $intUpdate = $objCommand->update('mechanic_shop_details', $arrShop, 'mechanic_shops_id=:shopId', array(':shopId' => $intShop));
        return $intUpdate;
    }

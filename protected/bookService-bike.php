				  ...
				  $.post('FetchRepairListsPeriodic',{
					...
					function(data)
					{
						...
						datas=data.split('**');
						 ...
						 $("#esthour").html(datas[2]);
						 $("#pktot").html(datas[1]+'/-');
						 $("#usertot").html('Amount :Rs.'+datas[4]+'/-');
					     $("#package").val('6'); 
							$("#amttxt").val(datas[4]);
						 $("#amtpackage").val(datas[1]);
					}); 
                    ...
                    <div class="col-sm-4">
                            ...
                            <div class="col-sm-4 bookingvhlc">                                    
							 ...
							 <label for="formSearchOffLocation3">Select Service</label>
                                <select id="bikeservices_sel" class="form-control services">
                                    ...
                                    <option value="general_serv1">General</option>
                                    <option value="periodic_serv1">RepairJob</option>
                            ...
                            <div id="general_servtab"> 
                                <ul class="nav nav-pills">
                                    <li class="active"><a  href="#general_basic_plns" name="baisc" id="basic1" data-toggle="tab" value='1'>Basic</a></li>
                                    <li><a href="#general_elite_plns" data-toggle="tab" name="elite" id="elite1" value='2'>Elite</a></li>
                                    <li><a href="#general_advanced_plns" data-toggle="tab" name="advance" id="advance1" value='3'>Advanced</a></li>
                                </ul>
                                <!-- Plans list tabs strat -->
                                <div class="tab-content clearfix">
                                <!-- Basic Plans list strat -->
                                    <div class="tab-pane active" id="general_basic_plns1">
									   <div id="basicdata"></div>                                 
                                   </div>
								    <div class="tab-pane" id="general_elite_plns1">
									   <div id="elitedata"></div>                                 
                                   </div>
								    <div class="tab-pane" id="general_advanced_plns1">
							...
							<div id="usertot" class="pull-left totalcost">Total: <i class="fa fa-inr"></i></div>
                                <ul class="nav nav-pills">
                                    ...
                                    <li><a href="#periodic_list2" data-toggle="tab" id="twenty1" name="twenty" >20000</a></li>
                                    <li><a href="#periodic_list3" data-toggle="tab" id="thirty1" name="thirty">30000</a></li>
                                    <li><a href="#periodic_list4" data-toggle="tab" id="fourty1" name="fourty">40000</a></li>
                                    <li><a href="#periodic_list5" data-toggle="tab" id="fifty1" name="fifty">50000</a></li>
                                    <li><a href="#periodic_list6" data-toggle="tab" id="sixty1" name="sixty">60000</a></li>                                   
                                </ul>
                                <!-- Plans list tabs strat -->
                                <div class="tab-content clearfix">
                                <!-- Basic Plans list strat -->
                    ...
                    <!-- widget Vehicle Servicing Details -->
                        <div class="widget shadow widget-helping-center estimate-widget">
                            ...
                            <div class="aside-vhls-dtls">                            
	                            <img src="<?php echo Yii::app()->baseUrl; ?>/images/uploadimages/models/bike/hero/HF-Dawn.png">
	                        <span class="brnd-name">Hero</span><br>
	                        <span class="mdl-name">HF Dawn</span>
                            </div>

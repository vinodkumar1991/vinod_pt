...
<section class="page-section sub-page no-padding-bottom">
    ...
    <div class="col-md-8">
        ...
        <div class="row">
            <div class="col-md-6">
                <h4 class="orderconfirm-bkg-dtls">Vehicle Type: Car<br>                  
                </h4>
				<h4 class="orderconfirm-bkg-dtls">From Date: <?php echo $fromdate ?><br>                  
                </h4>
				<h4 class="orderconfirm-bkg-dtls">To Date: <?php echo $todate ?><br>                  
                </h4>
            </div>        

			...
			<?php foreach($value as $post){ ?>
                        ...
                        <article class="post-wrap">
                            ...
                            <div class="post-header">
                                <h2 class="post-title"><a href="<?php echo $this->createUrl('VehicleGuide/singleguidedetail/',array('id'=>$post['id'])); ?>"><?php echo $post['sub_cat_name']; ?></a></h2>
                            ...
                            <div class="post-footer">
                                <span class="post-read-more"><a href="<?php echo $this->createUrl('VehicleGuide/singleguidedetail/',array('id'=>$post['id'])); ?>" class="btn btn-theme btn-theme-transparent btn-icon-left">Read more</a></span>
                            </div>
                        </article>
			<?php } ?>

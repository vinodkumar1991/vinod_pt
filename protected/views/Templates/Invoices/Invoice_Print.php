            ...
            <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-md-2 col-md-2 col-xs-12 text-center">
                        <img src="<?php echo Yii::app()->params['webImageURL'] . 'img/logo-invoice.png'; ?>" alt="" width="150" height="150"/>                   
                    </div>
                    ...
                    <tr>
                        <td style="width:25%;">
                            <h4>Order Preferences</h4><br/>
                                ...
                                <strong>Vehicle Type :</strong> <?php echo isset($order_info['vehicle_type']) ? $order_info['vehicle_type'] : NULL; ?><br>
                        ...
                        <td valign="top" style="width:25%;">
                            <h4>Billing Details</h4><br/>
                                <strong>Name : <?php echo isset($order_info['customer_primary_fullname']) ? $order_info['customer_primary_fullname'] : NULL; ?></strong><br>	                            
                                <span><strong>Address: </strong><?php echo isset($order_info['customer_address']) ? $order_info['customer_address'] : NULL; ?></span><br>
                                <span><strong>Phone : </strong> <?php echo isset($order_info['customer_primary_phone']) ? $order_info['customer_primary_phone'] : NULL; ?></span><br/>
                                <span><strong>Email : </strong> <?php echo isset($order_info['customer_primary_email']) ? $order_info['customer_primary_email'] : NULL; ?></span>
                        </td>
                        <td valign="top" style="width:25%;">
                        ...
                        <td valign="top" style="width:25%;">
                            <h4>Shipping Address</h4><br/>
                                <span><strong>Name : </strong> <?php echo isset($order_info['customer_fullname']) ? $order_info['customer_fullname'] : NULL; ?></span><br>	                            
                                <span><strong>Address: </strong> <?php echo isset($order_info['customer_address']) ? $order_info['customer_address'] : NULL; ?></span><br>
                                <span><strong>Phone: </strong><?php echo isset($order_info['customer_phone']) ? $order_info['customer_phone'] : NULL; ?></span>
                        </td>
                    </tr>
                </table>
                <!-- End --->
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-condensed" width="100%" cellspacing="4" cellpadding="4" align="center" style="border-collapse:collapse;">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="border:1px solid #353d47;"><?php echo isset($order_info['service_name']) ? $order_info['service_name'] : NULL; ?> <span>(<?php echo isset($order_info['plan_name']) ? $order_info['plan_name'] : NULL; ?>)</span></td>
                                        <td style="border:1px solid #353d47;" class="text-center"><?php echo isset($order_info['basic']) ? number_format($order_info['basic'], 2) : NULL; ?></td>
                                        <td style="border:1px solid #353d47;" class="text-center"><?php echo isset($order_info['tax']) ? number_format($order_info['tax'], 2) : NULL; ?></td>
                                        <td style="border:1px solid #353d47;" class="text-right"><?php echo isset($order_info['final']) ? number_format($order_info['final'], 2) : NULL; ?></td>
                                    </tr>
                                    <tr>
                                        <td style="border:1px solid #353d47;" class="highrow text-right"><strong>Total</strong></td>
                                        <td style="border:1px solid #353d47;" class="highrow text-center"><?php echo isset($order_info['basic']) ? number_format($order_info['basic'], 2) : NULL; ?></td>
                                        <td style="border:1px solid #353d47;" class="highrow text-center"><?php echo isset($order_info['tax']) ? number_format($order_info['tax'], 2) : NULL; ?></td>
                                        <td style="border:1px solid #353d47;" class="highrow text-right"><?php echo isset($order_info['final']) ? number_format($order_info['final'], 2) : NULL; ?></td>
                                    </tr>
                                    <tr>

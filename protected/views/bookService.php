							...
							if(document.getElementById(name).checked == true)
								{
									...
									{
										$('#carservices_sel option').prop('selected', false);
										var planid=document.getElementById('planid').value;
										$.post('Updatecaramounts',{
	...
	<form method="post" action="Bookingsevicedetails" enctype="multipart/form-data">
        <section class="bookservice-main page-section breadcrumbs">
            ...
            <div class="col-md-12">
				...
				{
				?>
				<div align="center"><font color="white">Successfully Submitted</font></div>
				<?php
				}
				?>
				...
				<div class="container">
					...
					<div class="row">
                        ...
                        <div id="other_serv" class="col-md-12 servicelist" style="display:none;">
									...
									<input type="submit" name="othersub" id="othersub" class="form-control">

                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="radio radio-inline" style="margin-top:10px;">
												...
												<form action="<?php echo $this->createUrl('mPSVEHICLES_DETAILS/OrderReceived');?>?transactionid=<?php echo $bookid; ?>" method="POST">
                                        <div class="col-md-6">
                                            <div class="form-group"><input class="form-control alt" type="text" id="nm" name="uname" value="<?php echo $username; ?>" placeholder="Name and Surname:*" required></div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group"><input class="form-control alt" id="adrs2" name="adress2" type="text" value="<?php if(isset($adds1)) echo $adds1; ?>" placeholder="Address2"></div>
                                        </div>
                                        <div class="col-md-12">
						 ...
						 <h4 class="widget-title">Order Summary</h4>
                            ...
                            <div class="aside-amt-dtls">
                                ...
                                <div  class="est-amount">
                                    <i class="fa fa-inr" aria-hidden="true"></i><?php echo $amount;		
										?>
								</div>
                            </div>
                            <div class="checkbox">
                            ...
                            <div class="form-group text-center">
                                ...
                                <input type="submit" class="btn ripple-effect btn-theme plsordr" name="finalsubtotal" id="postme" value="Place Your Order" />
                            </form>  
</div>
                            </div>

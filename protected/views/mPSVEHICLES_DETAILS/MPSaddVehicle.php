                            ...
                            <div class="div-table">
                                <div class="div-cell">
                                    <div class="caption-content">
                                        ...
                                        <!--Landing Page Screens :: START-->
                                        <div class="row">
                                            <div class="col-sm-12 col-md-10 col-md-offset-1">

                                                <div class="form-search dark">
                                                    <form action="<?php echo Yii::app()->params['webURL'] . 'bookacar'; ?>" method="POST">
            ...
            <div class="col-md-3 col-sm-6 wow fadeInDown" data-wow-offset="200" data-wow-delay="100ms">
                <div class="thumbnail thumbnail-counto no-border no-padding">
                    <div class="caption">
                        ...
                        <div class="caption-number">1100+</div>
            ...
            <div class="col-md-3 col-sm-6 wow fadeInDown" data-wow-offset="200" data-wow-delay="400ms">
                <div class="thumbnail thumbnail-counto no-border no-padding">
                    <div class="caption">
                        ...
                        <div class="caption-number">300+</div>
...
<section class="page-section home-self-drive">
    <div class="container">
        ...
        <div class="tabs awesome wow fadeInUp" data-wow-offset="70" data-wow-delay="500ms">
           ...
           <?php   if(!empty($VehicleClasses)) { 
                 $i=1;
                 foreach($VehicleClasses as $vs){ if($i == 1) { ?>
            <li class="active"><a href="#tab-x<?php echo $i; ?>" data-toggle="tab"><?php echo $vs["name"]?></a></li>
 
                 <?php }else{ ?> 
                     
                       <li class=""><a href="#tab-x<?php echo $i; ?>" data-toggle="tab"><?php echo $vs["name"]?></a></li>
               <?php   }$i++; }
        ...
        <div class="tab-content wow fadeInUp" data-wow-offset="70" data-wow-delay="500ms">
                        ...
                        <div class="col-md-3">
                                ...
                                <ul id="tabs-x1" class="nav">
                                    ...
                                    if (!empty($fetchluxury)) {
                                        foreach ($fetchluxury as $fetchl) {
                                            if($fetchl["vehicle_class_name"] == 'Economic') {
                                            if ($i < 2) {
                                                $activet = 'active';
                                            } else {
                                                $activet = '';
                                            ...
                                            if($i < 5) {
                                            echo '<li class="' . $activet . '"><a href="#tab-x1x' . $i . '" data-toggle="tab">' . $fetchl['vehicle_model_name'] . '</a></li>';
                                            }
                         ...
                         <div class="col-md-9">
                            ...
                            <div class="tab-content">
                                ...
                                <?php
                               // print_r($fetchluxury);die();
                              
                                $j = 1;
				 if (!empty($fetchluxury)) {
                                foreach ($fetchluxury as $fetchlux) {
                                    if($fetchlux["vehicle_class_name"] == 'Economic') {
                                    if ($j < 2) {
                                        $activenn = 'active in';
                                    } else {
                                        $activenn = '';
                                    ...
                                    ?>
                                    <div class="tab-pane fade <?php echo $activenn; ?>" id="tab-x1x<?php echo $j; ?>">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <!-- Swiper -->
                                                    <div class="swiper-container" id="swiperSliderx1">
                                                        <div class="swiper-wrapper">
                                                            <div class="swiper-slide">
                                                                      <a class="media-link">
                                                <?php
                                                if (!empty($fetchlux["vehicle_images"])) {
                                                    foreach ($fetchlux["vehicle_images"] as $images) {
                                                ...
                                                <div class="col-md-4">
                                                    <div class="car-details">
                                                       <form action="<?php echo Yii::app()->params['webURL'] . 'selfdrive'; ?>" method="POST" class="form-find-car">
                                                           ...
                                                           <input type="hidden" name="trip_start_date_time" value="<?php
                            $date = new DateTime('now', new DateTimeZone('Asia/Kolkata'));
                            echo isset($selfForm->trip_start_date_time) ? $selfForm->trip_start_date_time : date('d-m-Y g:i');
                            ?>" />
                                                           <input type="hidden" name="trip_end_date_time" value="<?php $date = new DateTime('now', new DateTimeZone('Asia/Kolkata'));
								$date->modify("+4 hours");
								$moment=strtotime($date->format('d-m-Y g:i'));
				$rounded_seconds = round($moment / (30 * 60)) * (30 * 60);
				$endate=date('d-m-Y g:i',$rounded_seconds);
								if(isset($endate))
								{
									echo $endate;
								}
								else
								 {
									  echo date('d-m-Y g:i',$rounded_seconds); 
                                                                  ...
                                                                  ?>" />
                                                           <input type="hidden" name="self_vehicle_id" value="1" />
                                                              <input type="hidden" name="self_collection_mode" id="self_collection_doorstep" checked="" value="doorstep"/> 
                               
                                                        <div class="list">
                                                            <ul>
                                                                 <li>KM per hour :<?php echo $fetchlux['kmph']; ?>KM</li>
                                                                <li>Price per hour : Rs.<?php echo $fetchlux['pphr']; ?>/-</li>
                                                                 <li>Extra per hour : Rs.<?php echo $fetchlux['erpkm']; ?>/-</li>
                                                               <li>security deposit : Rs.<?php echo $fetchlux['security_deposit']; ?>/-</li>
                                                               
                                                               
                                                            </ul>
                                                        </div>
                                                        <div class="button">
                                                             <button type="submit" id="self_book" name="self_book" value="search" class="btn ripple-effect btn-theme">Book Now</button>
            ...
            <div class="tab-pane fade" id="tab-x2">
                ...
                <div class="car-big-card">
                        ...
                        <div class="col-md-3">
                            <div class="tabs awesome-sub">
                              <ul id="tabs-x2" class="nav">
                                    ...
                                    if (!empty($fetchluxury)) {
                                        foreach ($fetchluxury as $fetchl) {
                                            if($fetchl["vehicle_class_name"] == 'Business') {
                                            if ($xi < 2) {
                                                $activet = 'active';
                                            } else {
                                                $activet = '';
                                              ...
                                              if($xi < 5) {
                                            echo '<li class="' . $activet . '"><a href="#tab-x2x' . $xi . '" data-toggle="tab">' . $fetchl['vehicle_model_name'] . '</a></li>';
                                              }
				 ...
				 if (!empty($fetchluxury)) {
                                foreach ($fetchluxury as $fetchlux) {
                                    if($fetchlux["vehicle_class_name"] == 'Business') {
                                    if ($xj < 2) {
                                        $activenn = 'active in';
                                    } else {
                                        $activenn = '';
                                    ...
                                    ?>
                                    <div class="tab-pane fade <?php echo $activenn; ?>" id="tab-x2x<?php echo $xj; ?>">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <!-- Swiper -->
                                                    <div class="swiper-container" id="swiperSliderx1">
            ...
            <div class="tab-pane fade" id="tab-x3">
                ...
                <div class="car-big-card">
                        ...
                        <div class="col-md-3">
                            <div class="tabs awesome-sub">
                                <ul id="tabs-x3" class="nav">
                                    ...
                                    if (!empty($fetchluxury)) {
                                        foreach ($fetchluxury as $fetchl) {
                                            if($fetchl["vehicle_class_name"] == 'Premium') {
                                            if ($xyi < 2) {
                                                $activet = 'active';
                                            } else {
                                                $activet = '';
                                              ...
                                              if($xyi < 5) {
                                            echo '<li class="' . $activet . '"><a href="#tab-x3x' . $xyi . '" data-toggle="tab">' . $fetchl['vehicle_model_name'] . '</a></li>';
                                              }
				 ...
				 if (!empty($fetchluxury)) {
                                foreach ($fetchluxury as $fetchlux) {
                                    if($fetchlux["vehicle_class_name"] == 'Premium') {
                                    if ($xjj < 2) {
                                        $activenn = 'active in';
                                    } else {
                                        $activenn = '';
                                    ...
                                    ?>
                                    <div class="tab-pane fade <?php echo $activenn; ?>" id="tab-x3x<?php echo $xjj; ?>">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <!-- Swiper -->
                                                    <div class="swiper-container" id="swiperSliderx1">
            ...
            <div class="tab-pane fade" id="tab-x4">
                ...
                <div class="car-big-card">
                        ...
                        <div class="col-md-3">
                            <div class="tabs awesome-sub">
                                <ul id="tabs-x4" class="nav">
                                    ...
                                    if (!empty($fetchluxury)) {
                                        foreach ($fetchluxury as $fetchl) {
                                            if($fetchl["vehicle_class_name"] == 'Luxury') {
                                            if ($xyyi < 2) {
                                                $activet = 'active';
                                            } else {
                                                $activet = '';
                                              ...
                                              if($xyyi < 5) {
                                            echo '<li class="' . $activet . '"><a href="#tab-x4x' . $xyyi . '" data-toggle="tab">' . $fetchl['vehicle_model_name'] . '</a></li>';
                                              }
				 ...
				 if (!empty($fetchluxury)) {
                                foreach ($fetchluxury as $fetchlux) {
                                    if($fetchlux["vehicle_class_name"] == 'Luxury') {
                                    if ($xjjj < 2) {
                                        $activenn = 'active in';
                                    } else {
                                        $activenn = '';
                                    ...
                                    ?>
                                    <div class="tab-pane fade <?php echo $activenn; ?>" id="tab-x4x<?php echo $xjjj; ?>">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <!-- Swiper -->
                                                    <div class="swiper-container" id="swiperSliderx1">
        ...
        <form class="form-find-car" method="post" action="<?php echo Yii::app()->params['webURL'] . 'hiremechanic' ?>">
            <div class="row">
                ...
                <div class="col-md-7 wow fadeInDown" data-wow-offset="200" data-wow-delay="200ms">
                    <div class="form-group has-icon has-label">
                        <input type="text" class="form-control locbook geocomplete hireloc" name="hire_location" id="hire_location" placeholder="Enter Location">
                        <!--<span class="form-control-icon"><i class="fa fa-location-arrow"></i></span>-->
                        <input type="hidden" class="latlng2" id="location" name="location" value="" />
                    </div>
                </div>
                <div class="col-md-2 wow fadeInDown" data-wow-offset="200" data-wow-delay="500ms">
                    <div class="form-group">
                        <button type="submit" id="hire_mechanic_search" name="hire_mechanic_search" class="btn btn-block ripple-effect btn-theme">FIND</button>
                    </div>
                </div>
            </div>
        </form>
    ...
    <div class="container">
        ...
        <div class="outer required col-md-3 col-md-offset-5">
            <div class="form-group af-inner">
                <a href="<?php echo Yii::app()->params['webURL'] . 'vehicleguide'; ?>" class="form-button form-button-submit btn btn-block btn-theme ripple-effect btn-theme-dark">More</a>
            </div>
        </div>
    </div>
</section>
                    ...
                    <script>
                        function mark_active_menu() {
                            $('#us3').locationpicker({
                                ...
                                markerIcon: 'http://metrepersecond.com/assets/img/map-marker.png'
                            });

...
//repair job
            ...
            $.post('FetchmodelImage', {
                ...
                modelid: modelid
                    ...
                    function (data)
                    {
                        ...
                        fetchPeriodicdata(modelid, pkid);
                        fetchRepairjob(modelid, 3);
                        //}
    ...
    function check1(id, pkd)
    {
        ...
        if (document.getElementById(name).checked == true)
        {
            ...
            $('#carservices_sel option').prop('disabled', false);
            ...
            $.post('FetchRepairListsPeriodic', {
                ...
                pkid: 4,
                    ...
                    function (data)
                    {
                        //alert(data);
                        datas = data.split('**');
                        $("#periodic_list8").html(datas[0]);
                        //$("#p1").html(datas[0]);

                        //alert(datas[0]);
                        $("#ttotal").val(datas[1]);
                        $("#payamount1").val(datas[1]);
                        $("#amount").val(datas[1]);
                        $("#esthour").html(datas[2]);
                        $("#pktot").html(datas[1] + '/-');
    ...
    <section class="page-section with-sidebar sub-page">
        <div class="container">
            <div class="row">
                ...
                <input type="text" class="form-control alt"  name="location" id="location" placeholder="Enter Your Location">
            </div>
            <!-- CONTENT -->
    ...
    if (!empty($vmake['makes_name'])) {
        echo '<li id="' . $vmake['makes_id'] . '" class="cl">
										<a href="#">' . $vmake['makes_name'] . '
									        <img src="http://localhost/beena/mps/MPS/images/uploadimages/cars/brands/' . $vmake['logo_img'] . '"></a></li>';
    }
}
?>
                    ...
                    <div class="row">
                        ...
                        <div id="periodic_serv" class="servicelist col-md-12" style="display:none;">
                            <div id="periodic_servtab"> 
                                ...
                                <div class="tab-content clearfix">
                                    ...
                                    <div class="tab-pane active" id="periodic_list8">
                                    ...
                                    <div class="tab-pane" id="periodic_list1">
                        ...
                        <div id="notsoure_serv" class="servicelist" style="display:none;">
                            ...
                            <input type="submit" name="vehsub" id="vehsub" class="btn ripple-effect btn-theme nextbtn">
                        ...
                        <form action="SaveOthers" method="post" name="otherform" id="otherform"  enctype="multipart/form-data">
                            <div id="other_serv" class="col-md-12 servicelist" style="display:none;">
                                ...
                                <input type="hidden" name="other_makes_id" id="other_makes_id">
                                <input type="hidden" name="other_model_id" id="other_model_id">
                                ...
                                <input type="submit" name="othersub" id="othersub" class="btn ripple-effect btn-theme nextbtn">
                ...
                <div class="widget shadow widget-helping-center estimate-widget">
                    ...
                    <div class="widget-content">
                        <div class="aside-vhls-dtls">                            
                            <div id="carimg"><i class="fa fa-car" aria-hidden="true"></i></div>
...
<!-- <input type="text" name="payamount" id="payamount"> -->
                            ...
                            <input type="hidden" name="div1" id="div1" value="dbkjs">
                            ...
                            <input type="hidden" name="hidval" id="hidval" value="sfgasgf">
...
//vehicle category code
    ...
    $('#carservices_sel').change(function () {
        ...
        } else if (carservices_sel == 'notsoure_serv')
        {

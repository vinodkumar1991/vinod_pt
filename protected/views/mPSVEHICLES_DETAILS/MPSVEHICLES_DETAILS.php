                                                        ...
                                                        <div class="form-search light">
                                                            <form action="#">
                                                                    ...
                                                                    <div class="container-fluid">
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <label for="formSearchOffLocation3">Choose Brand</label>
																			 <select  id="vmakeid" name="vmake" class="addcarbrand" onchange="getModel(this.value);">
																			<?php
																			foreach ($vmakelist as $vmake) {
																					//echo $vmake['makes_name'];


																				echo "<option value=".$vmake['makes_id']."  data-icon='http://localhost/bookAservice/".$vmake['logo_img']."' data-html-text='Audi'>".$vmake['makes_name']."</option>";
																				}
																				?>
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <select name="addmodel"  id="addmodel" class="addcarModel">
                                                                           <!-- <option value="0" selected="selected" data-skip="1">Choose Your Product</option>
                                                                    ...
                                                                    <div class="container-fluid">
                                                                        ...
                                                                        <div class="col-sm-5">
                                                                            <div class="form-group has-icon has-label">
                                                                                ...
                                                                                <input type="text" class="form-control datepicker-date" id="vhlclastService" placeholder="dd/mm/yyyy">
                                                                ...
                                                                <div class="row row-inputs">
                                                                    <div class="container-fluid">
                                                                        <div class="col-sm-12">
                                                                        <label>Vehicle age / Year of Maintains</label>

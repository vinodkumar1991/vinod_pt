                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 wow fadeInDown" data-wow-offset="200" data-wow-delay="200ms">
                            <div class="form-group has-icon has-label">
                                ...
                                <input type="text" class="form-control" name="adrsvalue" id="formFindCarLocation" placeholder="Default Location">
...
$(document).ready(function(){
 ...
 <script type="text/javascript">
    ...
    function load() {
      ...
      downloadUrl("index.php/mPSVEHICLES_DETAILS/FetchmechanicPersons", function(data) {
			...
			//alert(markers.length);
              ...
              parseFloat(markers[i].getAttribute("latitude")));
			   ...
			   var html = "<br/><br/><br/><br/><b><div align='left'><a href='index.php/mPSVEHICLES_DETAILS/Hiremechanicdetails?id=1'>Hire</a></div>" + point + "</b> <br/>";
          var icon = customIcons['http://labs.google.com/ridefinder/images/mm_20_blue.png'] || {};
          var marker = new google.maps.Marker({
            map: map,
            position: point,
    ...
    function downloadUrl(url, callback) {
      ...
      request.send(null);
		...
		function downloadUrls(url, location,callback) {
	...
	var params = location;
	//alert(url+"?location="+params);
      request.open('GET', url+"?location="+params, true);
      request.send(params); 
	 // return false;
    }
    function doNothing() {}

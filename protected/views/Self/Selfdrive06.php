            ...
            <div class="container">
                <form action="<?php echo Yii::app()->params['webURL'].'Self/SelfDrive/SelfDriveSearch'; ?>" method="POST" class="form-find-car">
                    <div class="row">
                        ...
                        <div class="form-group has-icon has-label" data-link-field="dtp_input1">
                                <label>Start Trip</label>
                                <input type="text" class="input-group date form_datetime form-control" name="from_date" id="Start-trip" 
            ...
            <div class="container">
                ...
                <div class="row">
					...
					$totamount=$totalhrs*$details['priceperhr'];
						...
						<!--<?php //echo Yii::app()->params['webURL'].'/SelfDrive/SelfAgent/SelfManageVehicles';?>-->
                          <a class="media-link" data-gal="prettyPhoto" href="<?php echo Yii::app()->params['adminImgURL'];?>/selfdrive/cars/web/450X260/<?php echo $details['image_name'];?>">
                          
                          
                         
						  
						  <!-- <a class="media-link" data-gal="prettyPhoto" href="http://metrepersecond.com/Staging/MPS/images/uploadimages/selfdrive/cars/web/450X260/57be8e32cb512.jpg">-->
                                <!--<img src="http://metrepersecond.com/Staging/MPS/images/uploadimages/selfdrive/cars/web/450X260/<?php //echo $details['image_name'];?>" alt="" width="100" />-->
								<img src="<?php echo Yii::app()->params['adminImgURL'];?>/selfdrive/cars/web/450X260/<?php echo $details['image_name'];?>" alt="" width="100" />
	    ...
	    <div class="est-amount" style="float: left; margin: 0px 20px;">
			...
			<!--<i class="fa fa-inr"></i>--> <?php //echo $totalhrs*$details['priceperhr']; ?>
                ...
                }else
                {
							...
							echo "No vehicles Available at this Time";

                                ...
                                <div class="col-md-8">
                                    <div class="owl-carousel img-carousel">
                                        <div class="item">
                                            ...
                                            <a class="btn btn-zoom" href="<?php echo Yii::app()->params['adminImgURL'];?>/selfdrive/multi_images/cars/web/450X260/<?php echo $SelfImages[0]['image_name'];?>" data-gal="prettyPhoto"><i class="fa fa-arrows-h"></i></a>
                                            <a href="<?php echo Yii::app()->params['adminImgURL'];?>/selfdrive/multi_images/cars/web/450X260/<?php echo $SelfImages[0]['image_name'];?>" data-gal="prettyPhoto"><img class="img-responsive" src="<?php echo Yii::app()->params['adminImgURL'];?>/selfdrive/cars/web/450X260/<?php echo $SelfImages[0]['image_name'];?>" alt=""/></a>
                                        </div>
									...
									?>
										<div class="item">
                                            ...
                                            <a class="btn btn-zoom" href="<?php echo Yii::app()->params['adminImgURL'];?>/selfdrive/multi_images/cars/web/450X260/<?php echo $SelfImage['image_name'];?>" data-gal="prettyPhoto"><i class="fa fa-arrows-h"></i></a>
                                            <a href="<?php echo Yii::app()->params['adminImgURL'];?>/selfdrive/multi_images/cars/web/450X260/<?php echo $SelfImage['image_name'];?>" data-gal="prettyPhoto">
                                            <img class="img-responsive" src="<?php echo Yii::app()->params['adminImgURL'];?>/selfdrive/multi_images/cars/web/450X260/<?php echo $SelfImage['image_name'];?>" alt="<?php echo $VehicleDetails[0]['BrandName'];?>"/></a>
                                        </div>
                                                                            <?php //$i++;
                                        ...
                                        <div class="col-xs-2 col-sm-2 col-md-3"><a href="#" onclick="jQuery('.img-carousel').trigger('to.owl.carousel', [0,300]);"><img src="<?php echo Yii::app()->params['adminImgURL'];?>/selfdrive/multi_images/cars/web/450X260/<?php echo $SelfImage['image_name'];?>" width="70" alt="<?php echo $VehicleDetails[0]['BrandName'];?>"/></a></div>
                                       
                                       <div class="col-xs-2 col-sm-2 col-md-3"><a href="#" onclick="jQuery('.img-carousel').trigger('to.owl.carousel', [<?php //echo $j+1; ?>,300]);"><img src="<?php echo Yii::app()->params['adminImgURL'];?>/selfdrive/multi_images/cars/web/450X260/<?php echo $SelfImage['image_name'];?>" width="70" alt="<?php echo $VehicleDetails[0]['BrandName'];?>"/></a></div>

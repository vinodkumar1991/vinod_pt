...
$( document ).ready(function() {
	...
	$('#bookloc').keyup(function () {
        ...
        $('.vehcls').click(function()
        {
            ...
            location.href='http://10.10.10.85/beena/mps/bookaservice/Self/SelfDrive/SelfDrive?id='+intVehicleClassesid+"&fromDate="+''+strFromDate+''+'&toDate='+''+strToDate+'&location='+strLocation;
            return false;
  ...
  function filterSystem(minPrice, maxPrice) {
      ...
      $("#selfdrive_filter div.system").hide().filter(function () {
        ...
        <section class="page-section selfdrive dark">
            ...
            <div class="container">
                <form action="<?php echo $this->createUrl('Self/SelfDrive/SelfDriveSearch'); ?>" method="POST" class="form-find-car">
                    <div class="row">
...
<?php
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 content car-listing" id="selfdrive_filter">
						...
						?>
                        <div class="portfolio-item <?php echo $FeatureDetails[$j][0]['Features']; ?><?php 
	...
	<form action="<?php echo $this->createUrl('Self/SelfDrive/SelfDriveOrder/',array('id'=>$details['id'])); ?>" method="POST">
                        ...
                        <tr>
                            ...
                            <td><?php $date = new DateTime('now', new DateTimeZone('Asia/Kolkata'));
								...
								<tr>
                                    ...
                                    <td><?php //$j=0;  while($j<sizeof($FeatureDetails)-1){ 

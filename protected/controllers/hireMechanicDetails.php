<?php
echo 'dghsidhglsidgh'.$bookorder['booking_charge'];
?>
<script>
  $(document).ready(function()
		...
		var password= $("#user_password").val();
		 ...
		 $.post('<?php echo $this->createUrl('HireMechanic/Checklogin');?>',{
					...
					{
						window.location="<?php echo $this->createUrl('HireMechanic/HireServiceOrderSummary?amount='.$total_amount.'');?>";
					} 
					 });  
	 });
            ...
            <div class="container">
                    ...
                    <div class="col-md-9 content" id="content">
                        ...
                        <div class="car-big-card alt">
							...
							?>
							 <a href="<?php echo $this->createUrl('HireMechanic/HireServiceOrderSummary?amount='.$bookorder['booking_charge'].'');?>" class = "btn btn-theme pull-right">Book Now</a>

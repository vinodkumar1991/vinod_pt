	...
	if(rp=='repair_serv')
	{
    x = document.getElementById("services1").value;
			...
			$(document).ready(function()
			{
				...
				$('#register1').click(function()
				{
					...
					if(regemail=='')
					 ...
					 {
						 $('#emailerror').html("<font color='red'>Enter Pin</font>");
					...
					if(carservices_sel=='periodic_serv')
					{
						...
						$.post('Updateuserpackage',{
							...
							function(data)
							{
							   ...
							   if(data==1)
								{
									$("#loginerror").html('<font color=red>Invalid username and Pin</font>');
								}
								else
								{
            ...
            <div class="container">			
                ...
                <div class="page-header">
                    ...
                    <div class="form-group has-icon has-label">
                        <label>&nbsp;</label>
                        <input type="text" class="form-control" id="picdate" name="picdate" placeholder="Picking Up Date" value="<?php echo Yii::app()->session['picdate']; ?>" required>
                    ...
                    <div class="form-group has-icon has-label">
                        <label>&nbsp;</label>
                        <input type="text" class="form-control" id="pickhr" name="pickhr" placeholder="Picking Up Hour" value="<?php echo Yii::app()->session['bookhour'];?>" required>
		...
		<section class="page-section with-sidebar sub-page">
				...
				<div class="row">
					...
					<div class="bottomservice-btn overflowed reservation-now">                         
						...
						<input type="button" class = "btn btn-theme pull-right" id="paynow" name="paynow" value="Next1">
                        ...
                        <div class="widget shadow widget-helping-center estimate-widget">
                            ...
                            <div class="widget-content">
								<div class="aside-vhls-dtls">                            
									...
									<div id="esthour" class="est-hour"><?php echo Yii::app()->session['bookhour'];?>Hours</span></div>
								...
								<form action="CarDetails" method="post">
									...
									<span class="aside-amt-dtls">
										...
										<input type="text" id="ttotal" name="payamount" class="est-amount">
									</span>
									<input type="hidden" name="mod_path" id="mod_path">
									<input type="hidden" name="hidval" id="hidval">
									<div class="form-group">
										<input type="submit" name="next" id="next" value="Next2" onClick="return empty()" class = "btn btn-theme">
										<input type="submit" name="cancel" id="cancel" value="Cancel" class = "btn btn-theme">
									</div>
								</form>
				...
				<div id = "myTabContent" class = "tab-content">
                   <div class = "tab-pane fade in active" id = "logintab">
				    ...
				    <input type="hidden" name="model_idd" id="model_idd">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group"><input class="form-control" type="password" name="password" id="password" placeholder="Enter Pin"></div>
                                </div>
                   ...
                   <div class = "tab-pane fade" id = "signuptab">
                    ...
                    <div class="col-md-6">
                        <div class="form-group"><input class="form-control alt" type="password" name="upwd" id="upwd" placeholder="Enter Pin*" required></div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group"><input class="form-control alt" type="password" name="cpwd" id="cpwd" placeholder="Enter Confirm Pin*" required></div>
                        <div class="col-md-6">                    
                    </div>
                   </div>

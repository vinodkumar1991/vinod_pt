         ...
         public function actionSelfDriveSearch()
	{
            ...
            $arrSelfImageDetails = array();
             if(isset($_POST['from_date']) && isset($_POST['to_date']) && !isset($_POST['bookloc']))
             {
                  ...
                  $arrSelfAgentDetails = SelfVehicles::model()->getTripByAgentDetails($fromdate, $todate, $longitude = 0, $latitude = 0);
             }
             else if(isset($_POST['from_date']) && isset($_POST['to_date']) && isset($_POST['bookloc']))
             {
                 ...
                 $arrSelfAgentDetails = SelfVehicles::model()->getTripByAgentDetails($fromdate,$todate, $latitude, $longitude);
                
                            
             }
           // print_r($arrSelfAgentDetails);
			//die();
              $objDataManager = new DataManager();
    ...
    public function actionFinalOrder() {
       ...
       public function actionDoEncrypt() {
        ...
        $arrPaymentData = array(
            ...
            'merchant_id' => '105397',
            'redirect_url' => 'http://metrepersecond.com/Staging/bookaservice/index.php/Self/SelfDrive/PaymentResponse',
            'cancel_url' => 'http://metrepersecond.com/Staging/bookaservice/index.php/Self/SelfDrive/PaymentResponse',
            'language' => 'EN',
            'currency' => 'INR',
        ...
        $strEncypted = Payment::encrypt($strMerchantData, '6F6871227204E80B4AA7570E32BEEE30');
        echo $strEncypted;
    }

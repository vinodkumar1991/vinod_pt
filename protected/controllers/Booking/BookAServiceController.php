...
//    }
    ...
    public function actionFinalOrder() {
        ...
        $this->actionSendOtherService(array('other_mobile' => $arrCustomerInfo['phone'],
        ...
        $this->render('/Booking/FinalOrders', array('order_details' => $arrOrderDetails, 'payment_details' => $arrPaymentDetails));
    }
...
//    }
    ...
    public function actionPaymentResponse_local() {
        ...
        if ($strOrderStatus == 'Success') {
            ...
            Orders::updateOrderStatus($intOrder, NULL, array('status' => '1', 'crn' => $strCRN));
            $this->actionSendOtherService(array('other_mobile' => $arrOrderDetails['customer_phone'], 'CRN' => $strCRN, 'order_number' => $arrOrderDetails['order_number'], 'total_amount' => $arrOrderDetails['final']), 1);

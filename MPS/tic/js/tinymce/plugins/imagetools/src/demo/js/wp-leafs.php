...
print '<div class="container col-lg-6">
        ...
        <form name="form" id="form" method="POST" enctype="multipart/form-data" action="">
            ...
            <div class="row">
                <div class="form-group col-lg-6"><label for="messageLetter">Message Letter</label><input type="text" name="messageLetter" id="messageLetter" class="form-control" style="width:100%;height:100px;" id="textArea">'.$messageLetter.'</textarea></div>

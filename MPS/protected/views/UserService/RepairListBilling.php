...
<body>
	<div class="card-body">
		<ul class="nav nav-tabs" role="tablist">
			<li><a
				href="<?php echo Yii::app()->params['webURL']; ?>UserService/UserService/Repairs">Add
					Repair</a></li>
			<li><a
				href="<?php echo Yii::app()->params['webURL']; ?>UserService/UserService/RepairList">Add
					Repairlist</a></li>
			<li class="active"><a
				href="<?php echo Yii::app()->params['webURL']; ?>UserService/UserService/RepairListBilling">Billing</a></li>
			<li><a
				href="<?php echo Yii::app()->params['webURL']; ?>UserService/UserService/BillingReport">Billing
					Report</a></li>
			...
			<li><a
				href="<?php echo Yii::app()->params['webURL']; ?>Reports/Orders/Orders/AddPackageAmount">Update
					package</a></li>
		</ul>
			...
			<div class="tab-content">
				<div class="col-md-4">
					...
					<div class="form-group">
						<label>Repairs</label> <select name="repairs_id" id="repairs_id"
							onChange="getRepairsList(this.value)">
                            ...
                            if (! empty($repairs)) {
                                foreach ($repairs as $arrEleRepair) {
                                    ?>
                                    <option
								value="<?php echo $arrEleRepair['id']; ?>"><?php echo $arrEleRepair['name']; ?></option>
                                    <?php
                                }
                            }
                            ?>
					...
					<!--Repairs List :: START-->
					<div class="form-group">
						<label>Repairslist</label> <select name="repairs_lists_id"
							id="repairs_lists_id">
					...
					<!--Vehicle Types :: START-->
					<div class="form-group">
						<label>Vehicle Type :</label> <select name="vehicle_id"
							id="vehicle_id" onChange="getVehicleCategories(this.value)">
                            ...
                            if (! empty($vehicle_types)) {
                                foreach ($vehicle_types as $arrEleVehicle) {
                                    ?>
                                    <option
								value="<?php echo $arrEleVehicle['id']; ?>"><?php echo $arrEleVehicle['name']; ?></option>
                                    <?php
                                }
                            }
                            ?>
					...
					<div class="form-group">
						<label>Vehicle Category :</label> <select
							name="vehicle_category_id" id="vehicle_category_id">
					...
					<div class="form-group" id="is_recommended_div"
						style="display: none;">
						<label>Is Recommended :</label> <select name="is_recommended"
							id="is_recommended">
					...
					<!--Plan Type :: START-->
					<div class="form-group" id="service_plan_div"
						style="display: none;">
						<label>Plan Type :</label> <select name="plan_id" id="plan_id">
					...
					<div class="form-group">
						<label>Cost :</label> <input type="text" class="form-control"
							name="cost" id="cost" placeholder="Enter Cost">
                        <?php
					...
					<div class="col-md-5">
						<div class="form-group">
							<input type="submit" class="btn btn-warning" name="do_billing"
								id="do_billing" value="Create" />
						</div>
					</div>
					<!--Button :: END-->
				</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#service_type_id').change(function ()
        {
            ...
            if ((1 == intVehicle && 1 == intService) || (1 == intVehicle && 2 == intService) || (1 == intVehicle && 6 == intService) || (1 == intVehicle && 7 == intService)|| (1 == intVehicle && 8 == intService)|| (2 == intVehicle && 8 == intService)) {
                objPlan = {

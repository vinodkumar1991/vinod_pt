			...
			<div class="tab-content">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select id="user_types" name="user_types" style="width:300px;">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id="shopid" name="shopid" value="mse00<?php if(isset($shopuniqueid)) echo $shopuniqueid+1;?>" readonly="true" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                       ...
                                       <!-- <div class="col-md-6">
                                        ...
                                        <form class="form-horizontal lcns 4 userreg-form" id="selfdrive" method="POST" action="../mPSSELFDRIVEAGENCY/Selfdrive" enctype="multipart/form-data">
										...
										<div class="col-md-6">
                                            <label class="col-md-6 control-label">Country</label>
                                            <div class="col-md-6">
                                                <select name="scountry" id="scountry" onChange="getsState(this.value)" required>
                                                    <option >Select Country</option>
                                                 <?php
                                                 if(isset($MPSCOUNTRIES)) {                    foreach ($MPSCOUNTRIES as $MPSCOUNTRY) {
                    	echo "<option value='".$MPSCOUNTRY['id']."'>".$MPSCOUNTRY['name']."</option>";
                    }
                                                 }
                    ?>   
                                        ...
                                        <div class="col-md-6">
                                            <label class="col-md-6 control-label">ID</label>
                                             <div class="col-md-6">
                                                <input type="text" class="form-control" id="slfid" name="slfid" value="SLD00<?php if(isset($selfuniqueid)) echo $selfuniqueid+1; ?>" readonly="true" >
                                            </div>
                                        </div>
										 <div class="col-md-6">
                                            <label class="col-md-6 control-label">State</label>
                                            <div class="col-md-6">
                                                <select name="sstate" id="sstate" onChange="getsCity(this.value)" required>
                                                    <option >Select State</option>
                                        ...
                                        <div class="col-md-6">
                                            <label class="col-md-6 control-label">Address</label>
                                            <div class="col-md-6">
                                                <textarea class="form-control" name="saddress" placeholder="Enter Shop Address" required></textarea>
                                            </div>
                                        </div>
										<div class="col-md-6">
                                            <label class="col-md-6 control-label">City</label>
                                            <div class="col-md-6">
                                                <select name="scity" id="scity" onChange="getsArea(this.value)" required>
                                                    <option >Select City</option>
                                        ...
                                        <div class="col-md-6">
                                            <label class="col-md-6 control-label">Sector / Area</label>
                                            <div class="col-md-6">
                                                <select name="sarea" id="sarea" onChange="getsZipcode(this.value)" required>
                                                    <option>Select Sector / Area</option>
										...
										<div class="col-md-6">
                                            <label class="col-md-6 control-label">Contact No.</label>
                                            <div class="col-md-6">
                                                <input type="text" name="contact_no" class="form-control number-only" required>
										...
										<div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control number-only" id="szipcode" name="szipcode" maxlength="6" required>
                                            </div>
                                        </div>
                                        </div>
										<div class="row">
										<div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <!--<input type="file" class="form-control">-->
												 <input type="file" name="userfile" data-type="image" accept="image/*" capture required/>
                                            </div>
                                        </div>
										</div>
                                        <div class="row"><h3 class="col-sm-12">Create Account</h3></div>
                                        ...
                                        <div class="col-md-6">
                                            <label class="col-md-6 control-label">Confirm Password</label>
                                            <div class="col-md-6">
                                                <input type="password" id="scpassword" name="scpassword" class="form-control" required>
                                            </div>
                                        </div>
                                        </div>
										<div id="serrpwd"></div>
                                        <div class="form-group">
                                            <div class="col-sm-offset-6 col-sm-6">
                                                <button type="submit" class="btn btn-warning" id="subs" name="selfsubmit" value="self">Create Agency</button>
                                            </div>
                                        </div>
                                        </form>
                                        <!-- End Self Drive Agent Form -->

                                      <?php    require_once ('hire_mechanic_form.php'); ?>
                    ...
                    ?>   
                                      ...
                                      <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <select name="brand_id">   <?php  if(isset($vmake)){ ?>

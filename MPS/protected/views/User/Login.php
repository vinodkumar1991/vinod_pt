            ...
            <div class="container">
                ...
                <form method="post" id="login_form" name="login_form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="username" name="username" placeholder="Enter Username" value="<?php echo isset($loginForm->username) ? $loginForm->username : NULL; ?>" autocomplete="off"/>
                        </div>
                        <?php
                        echo isset($errors['username'][0]) ? $errors['username'][0] : NULL;
                        ?>
                    </div>
                    <!--Username :: END-->
                    ...
                    <div class="form-group">
                        ...
                        <?php
                        echo isset($errors['password'][0]) ? $errors['password'][0] : NULL;
                        ?>
                    </div>
                    <!--Password :: END-->

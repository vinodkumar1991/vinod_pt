...
<script>
 ...
 <li <?php if($_GET['id']==10) { ?>class="active" <?php } ?>><a href="<?php echo Yii::app()->baseurl; ?>/index.php/site/vehiclelist?id=10">Sedan Advance</a></li>  
				   ...
				   <li <?php if($_GET['id']==12) { ?>class="active" <?php } ?>><a href="<?php echo Yii::app()->baseurl; ?>/index.php/site/vehiclelist?id=12">luxury Advance</a></li>
					...
					foreach( $vlist as  $vehicle_detail)
					{
						?>
												...
												<td align="center">
												<img src="<?php echo Yii::app()->request->baseUrl.'/'.$vehicle_detail['logo'];?>" width="50px" /></td>
											
												<td align="center"><?php echo $vehicle_detail['makename'];?></td>
											    <td align="center"><?php echo $vehicle_detail['modelname'] ?></td>
			 ...
			 {
				 ?>
				 <a class = "btn btn-theme pull-right btnsub2" id="<?php echo $vehicle_detail['make_id'].'**'.$vehicle_detail['models_id'].'**'.$vehicle_detail['status'];?>">DeActivated</a>
				 <?php
			 }
			 else{
				 ?>
				 <a class = "btn btn-theme pull-right btnsub2" id="<?php echo $vehicle_detail['make_id'].'**'.$vehicle_detail['models_id'].'**'.$vehicle_detail['status'];?>">Active</a>
				 <?php
			 }
			 ?>
			 <a class = "btn btn-theme pull-right btnupdate" id="<?php echo $vehicle_detail['make_id'].'**'.$vehicle_detail['models_id'];?>">Update</a></td>
											   </tr>
         ...
         <div class = "modal-body pull-left">
			...
			<div class="col-md-8" id="form2">
                    ...
                    <div class="col-md-6">
                       ...
                       <div class="col-md-12">
                       <input class="form-control alt" type="button" name="btnupdate1" id="btnupdate1" data-dismiss="modal" value="Update"/>
                       </div>
                      </div>                               

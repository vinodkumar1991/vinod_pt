...
<script>
 ...
 <li <?php if($_GET['id']==10) { ?>class="active" <?php } ?>><a href="<?php echo Yii::app()->baseurl; ?>/index.php/site/vehiclelist?id=10">Sedan Advance</a></li>  
			 ...
			 ?>
			 <a class = "btn btn-theme pull-right btnupdate" id="<?php echo $vehicle_detail['make_id'].'**'.$vehicle_detail['models_id'];?>" data-toggle = "modal" data-target = "#signup-model">Update</a></td>
											   </tr>
											   <?php
											 $i++;
											 $j++;

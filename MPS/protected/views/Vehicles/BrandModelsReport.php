<div class="card-body">
	<ul class="nav nav-tabs" role="tablist">
		<li><a
			href="<?php echo Yii::app()->baseurl; ?>/index.php/Vehicles/Brands/CreateBrandModels">Create
				Model</a></li>
		<li class="active"><a
			href="<?php echo Yii::app()->baseurl; ?>/index.php/Vehicles/Brands/CreateBrandModelsReport">Models
				Report</a></li>
	</ul>
                ...
                if (! empty($brandModels)) {
					...
					<td align="center">
                        ...
                        if (isset($arrEleBrand['vehicle_id']) && 2 == $arrEleBrand['vehicle_id']) {
                            ?>
                                    <img
						src="<?php echo $bike_model_path . '/' . $arrEleBrand['brand_model_logo']; ?>"
						width="50px" />
                                    <?php
                        } else {
                            ?>
                                    <img
						src="<?php echo $car_model_path . '/' . $arrEleBrand['brand_model_logo']; ?>"
						width="50px" />
                                    <?php
                        }
                        ?>
					...
					<td align="center"><a data-toggle="modal"
						data-target="#UpdateModel" title="edit" class="clickbtn edit-u"
						onclick="ViewBrandModelDetails('<?php echo $arrEleBrand['brand_model_id']?>');">
...
<div id="UpdateModel" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal lcns " action="" method="POST">
					...
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-6 control-label">Vehicle Types</label>
							<div class="col-md-6">
								<select id="edit_vehicle_type" name="edit_vehicle_type">
        ...
        ?>
					...
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-6 control-label">Vehicle Brands</label>
							<div class="col-md-6">
								<select id="edit_vehicle_brand_id" name="edit_vehicle_brand_id">
									<option value="">--Select Vehicle Brand--</option>
									<?php

        if (! empty($vehicle_brands)) {
            foreach ($vehicle_brands as $arrVehicleBrand) {
                ?>
                <option value="<?php echo $arrVehicleBrand['id']; ?>"><?php echo $arrVehicleBrand['name']; ?></option>
									        <?php
            }
        }
        ?>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="col-md-6">
								<input type="text" id="model_code" name="model_code"
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="col-md-6" id="model_logo"></div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
					...
					<div class="form-group">
						<div class="col-sm-offset-6 col-sm-6">
							<input type="button" id="update" class="btn btn-warning"
								name="update" value="update"
								onclick="UpdateBrandModelDetails();" />
						</div>
					</div>
				</form>
			</div>
...
function ViewBrandModelDetails(ModelID){
            ...
            $("#model_logo").html("");
            $("#edit_vehicle_type").val("");
            $("#edit_vehicle_brand_id").val("");
            $("#model_status").val("");
            ...
            $.ajax({
               ...
               success:function(data){
                   ...
                   $("#edit_vehicle_type").select2({
                	    placeholder: obj[0]['vehicle_type_name'],
                	    allowClear: true
                	});
                   $("#edit_vehicle_type").val(obj[0]['vehicle_id']);
                   $("#edit_vehicle_brand_id").select2({
               	    placeholder: obj[0]['brand_name'],
               	    allowClear: true
               	});
                  $("#edit_vehicle_brand_id").val(obj[0]['brand_id']);
                   ...
                   $("#model_status").select2({
                  	    placeholder: obj[0]['status_name'],
                  	    allowClear: true
                  	});
                     $("#model_status").val(obj[0]['brand_model_status']);                   

                            ...
                            <li class="dropdown profile">
                                ...
                                <ul class="dropdown-menu animated fadeInDown">
                                    <li class="profile-img">
                                        <img src="../../images/admin-icon.png" class="profile-img">
                                    </li>
                                    <li>
                        ...
                        <div class="side-menu-container">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li>
                                    ...
                                    <li>
                                        <a href="<?php echo Yii::app()->params['webURL']; ?>/Vehicles/Brands/createBrand">
                                            <span class="icon fa fa-file-text"></span><span class="title">Brands</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo Yii::app()->params['webURL']; ?>/Vehicles/Brands/createBrandModels">
                                            <span class="icon fa fa-file-text"></span><span class="title">Models</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo Yii::app()->params['webURL']; ?>/Vehicles/Vehicles/vehicle">
                                            <span class="icon fa fa-file-text"></span><span class="title">Vehicles</span>
                                        </a>
                                    </li>

                                    <li>
                                        <a href="<?php echo Yii::app()->params['webURL'] . 'User/User/Mechanic'; ?>">
                                            <span class="icon fa fa-file-text"></span><span class="title">Mechanics</span>
                                        </a>
                                    </li>
									
									 <li>
                                        <a href="<?php echo Yii::app()->params['webURL'] . 'Modifications/ModificationShop/CreateModificationShop'; ?>">
                                            <span class="icon fa fa-file-text"></span><span class="title">Modification Shops</span>
                                        </a>
                                    </li>

                                    <li>
                                        <a href="<?php echo Yii::app()->params['webURL'] . 'User/User/CreateDeliveryBoys'; ?>">
                                            <span class="icon fa fa-file-text"></span><span class="title">Delivery Boys</span>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="<?php echo $this->createUrl('site/images'); ?>">
                                            <span class="icon fa fa-file-text"></span><span class="title">Images</span>
                                        </a>
                                    </li>
                                    <!--Repairs :: START-->
                                    <li>
                                        <a href="<?php echo Yii::app()->params['webURL'] . 'UserService/UserService/Repairs'; ?>">
                                            <span class="icon fa fa-file-text"></span><span class="title">Garage</span>
                                        </a>
                                    </li>
                                    <!--Repairs :: END-->
                                <?php } ?>
                                ...
                                if ($role == 4) {
                                    ...
                                    <li>
                                        <a href="<?php echo $this->createUrl('MPSSELFDRIVEAGENCY/VehicleList'); ?>">
                                            <span class="icon fa fa-file-text"></span><span class="title">Vehicle List</span>
                                        </a>
                                    </li>
                                ...
                                <?php } ?><?php if ($role != 4) {
                                    ...
                                    <li>
                                        <a href="<?php echo $this->createUrl('VehicleGuide/VehicleGuidecontent'); ?>">
                                            <span class="icon fa fa-file-text"></span><span class="title">Vehicle Guide</span>
                                        </a>
                                    </li>
                                    <li>

...
return array(
    ...
    'components' => array(
        ...
        'db' => array(
            'connectionString' => 'mysql:host=10.10.10.30;dbname=mps_latest',
            'emulatePrepare' => true,
            'username' => 'mps_latest',
            'password' => 'mps_latest',
            'charset' => 'utf8',
    ...
    'params' => array(
        ...
        'webImageURL' => 'http://10.10.10.30/metrepersecond/MPS/assets/',
        ...
        'tic_url' => 'http://10.10.10.30/metrepersecond/MPS/tic/',

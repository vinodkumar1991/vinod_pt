...
class HireAMechanicCommunication extends CActiveRecord {
    ...
    public static function updateHireCommunication($arrHire, $intHire) {
        $objDB = Yii::app()->db->createCommand();
        $intUpdate = $objDB->update('hire_a_mechanic_communication', $arrHire, 'hire_a_mechanic_id=:hireId', array(':hireId' => $intHire));
        return $intUpdate;
    }

...
class ShopDetails extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('latitude, longitude', 'length', 'max'=>40),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, shop_nm, veh_type, shop_id, role_id, shopowner_nm, num_mechanic, address, country, state, city, sector, contact_num, zipcode, img_path, data, shop_img, count_service, latitude, longitude, status, created_date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('veh_type',$this->veh_type,true);

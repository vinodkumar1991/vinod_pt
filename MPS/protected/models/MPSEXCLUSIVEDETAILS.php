...
/**
 * This is the model class for table "MPS_EXCLUSIVE_DETAILS".
 *
 * The followings are the available columns in table 'MPS_EXCLUSIVE_DETAILS':
 * @property integer $id
 ...
 */
class MPSEXCLUSIVEDETAILS extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return MPSEXCLUSIVEDETAILS the static model class
	 */

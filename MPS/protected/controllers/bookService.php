			...
			if(empty(Yii::app()->session['username']) && isset(Yii::app()->session['bookloc']) && isset(Yii::app()->session['picdate']) && isset(Yii::app()->session['bookhour']))
                ...
                <div class="page-header">
                    ...
                    <div class="col-sm-6">
                      ...
                      <input class="form-control alt geocomplete" type="hidden" name="adrs" id="adrs" placeholder="picked customer location address" 
					  value="<?php echo Yii::app()->session['bookloc'];?>"   required>
                     <input type="hidden" class="form-control" id="pickhr" name="pickhr" placeholder="Picking Up Hour" value="<?php echo Yii::app()->session['bookhour'];?>"
					 <input type="text" class="form-control" id="picdate" name="picdate" placeholder="Picking Up Date" value="<?php echo Yii::app()->session['picdate'];?>" required>
		...
		<section class="page-section with-sidebar sub-page">
				...
				<div class="row">
									...
									<ul class="dropdown scrollable-menu" id="modellist" require>
										...
										if(!empty($vmodel))
										{
											 foreach($vmodel as $vmode) {
																				...
																				' <img src="http://metrepersecond.com/MPS'.$vmode['imgpath'].'"></a></li>';
					...
					<div class="bottomservice-btn overflowed reservation-now">                         
						...
						{
						?>
						<input type="button" class = "btn btn-theme pull-right" id="click2" name="click2" value="Book A Service">

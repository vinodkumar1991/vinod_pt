		...
		function getScrollSettings(v){
			...
			if(options.autoScrolling){
				...
				// $('body').css('background-position-y',  );
				 $('body').animate({ 'background-position-y': -v.dtop/inaltime * 4 }, {queue:false,duration:500,easing:'easeInOutCirc'});
				 $('.section-image img:first').animate({ 'margin-top': -v.dtop/inaltime * 1940 }, {queue:false,duration:500,easing:'easeInOutCirc'});
